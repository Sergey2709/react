...
import { add, minus, multi, division, userText } from './app/taskReducerSlice';
...
export default function In() {
  ...
  const textHandler = () => {
    dispatch(userText(task2Input.current.value))
  }
  ...
  return (
    <div>
      ...
      <h2>Task 2</h2>
      <button onClick={textHandler}>Add your text to Storage</button>
    </div>
  );
}
